...
export default function Bandcamp(props) {
    ...
    return (
        <Card className="fauxmat-music-photo">
            {!hideTitle && (
                <Card.Header className="fauxmat-title">The Coastal Project, EP 2012</Card.Header>
            )}
            <Card.Body>
                <Row>
                    <Col md={7} sm={12} lg={8}>
                    ...
                    <Col md={5} sm={12} lg={4}>
                        <div className="fauxmat-about-text">
                            ...
                            This{' '}
                            <a
                                href="https://thecoastalproject.bandcamp.com/album/the-coastal-project-love-on-a-sunday"
                                target="_new">
                                bandcamp EP
                            </a>{' '}
                            is a collection of music I wrote in 2010/2011 featuring Erich Avinger,
                            Paul Chester, Mike Sunjka, Patrick Williams, Jr., Al Campbell, Steve
                            Brown, Ken Mondshine and Steve Allison. They, of course, played better
                            than the music deserved. If purchased, this eight-track set includes all
                            the sheet music. Hover over the image to hear individual tracks.
                        </div>
                    </Col>
                </Row>
            </Card.Body>
